    ...
    const renderResume = () => {
        resumeContainer.innerHTML = `
            ...
            <div class="personal-info" contenteditable="true" data-key="contact">
                <p><strong>Email:</strong> <span contenteditable="true" data-key="email">${resumeData?.email}</span></p>
                <p><strong>Phone:</strong> <span contenteditable="true" data-key="phone">${resumeData?.phone}</span></p>
                <p><strong>LinkedIn:</strong> <span contenteditable="true" data-key="linkedin">${resumeData?.linkedin || 'N/A'}</span></p>
            </div>
